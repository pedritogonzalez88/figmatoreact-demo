      ...
      >
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7mti")}
          >
            <Text
              fontFamily="Inter"
              fontSize="24px"
          ...
          <Divider
            ...
            {...getOverrideProps(overrides, "Dividersqr")}
          ></Divider>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7apn")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Divider
            ...
            size="small"
            orientation="horizontal"
            {...getOverrideProps(overrides, "Dividerdqr")}
          ></Divider>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7fid")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
      ...
      >
        ...
        >
          ...
          <Flex
            ...
            alignItems="flex-start"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 28nnb")}
          >
            <Button
              display="flex"
              gap="0"
              ...
              variation="primary"
              children="XXS"
              {...getOverrideProps(overrides, "Buttonjaj")}
            ></Button>
            <Button
              display="flex"
              gap="0"
              ...
              variation="primary"
              children="XS"
              {...getOverrideProps(overrides, "Buttonmxu")}
            ></Button>
            <Button
              display="flex"
              gap="0"
              ...
              variation="primary"
              children="S"
              {...getOverrideProps(overrides, "Buttonioi")}
            ></Button>
            <Button
              display="flex"
              gap="0"
              ...
              variation="primary"
              children="M"
              {...getOverrideProps(overrides, "Buttonkmm")}
            ></Button>
          </Flex>
          <Flex
            gap="24px"
            ...
            alignItems="flex-start"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 28ngn")}
          >
            <Button
              display="flex"
              gap="24px"
              ...
              variation="primary"
              children="L"
              {...getOverrideProps(overrides, "Buttonqdz")}
            ></Button>
            <Button
              display="flex"
              gap="24px"
              ...
              variation="primary"
              children="XL"
              {...getOverrideProps(overrides, "Buttonefv")}
            ></Button>
            <Button
              display="flex"
              gap="24px"
            ...
            <Button
              ...
              variation="primary"
              children="3XL"
              {...getOverrideProps(overrides, "Buttonrox")}
            ></Button>
          </Flex>
          <Text
            fontFamily="Inter"
